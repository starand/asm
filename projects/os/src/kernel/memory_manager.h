...
// відкидаємо 12 молодших та 10 старших біт в адресі TEMP_PAGE, зсуваємо - отримуємо PAGE_TABLE_INDEX - 10 біт
// множимо PAGE_TABLE_INDEX на 4 і отримуємо зміщення в таблиці KERNEL_PAGE_TABLE_OFFSET кратне 4 байти = 12 байт
// додаємо до KERNEL_PAGE_TABLE  + KERNEL_PAGE_TABLE_OFFSET - і отримуємо адресу 4х байт, в яких міститься адрес фізичної сторінки
